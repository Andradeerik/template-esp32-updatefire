...
#define AUTOCONNECT_MENULABEL_CONFIGNEW "Configurar WIFI"
...
#define AUTOCONNECT_MENULABEL_OPENSSIDS "Redes Guardadas"
...
#define AUTOCONNECT_MENULABEL_DISCONNECT "Desconectar WIFI"
